...
public class ProductsViewBean implements Serializable {
    ...
    public String doPurchase(){
        ...
        if (invalidProducts.size() == 0) {
            ...
            if (atLeast1Item){
                ...
                setErrorString("Se debe añadir al menos 1 item para realizar la compra.");
                action = null;
            }
        }
            ...
            err_sb.append("No se puede comprar. No existe suficiente stock disponible: ");
            ...
            err_sb.append(". Cantidades solicitadas en 0.");
    ...
    public String getSerialSortType() {
    ...
    public void setSerialSortType(String serialSortType) {
        this.serialSortType = serialSortType;
    }
    ...
    public String getUnitPriceSortType() {
    ...
    public void setUnitPriceSortType(String unitPriceSortType) {
        this.unitPriceSortType = unitPriceSortType;
    }
    ...
    public String getAmountSortType() {
    ...
    public void setAmountSortType(String amountSortType) {
        this.amountSortType = amountSortType;
    }

    public String getTotalPriceSortType() {
    ...
    public void setTotalPriceSortType(String totalPriceSortType) {
        this.totalPriceSortType = totalPriceSortType;
    }
    ...
    public String sortProductsByUnitPrice() {
        ...
        Collections.sort(filteredProducts, new Comparator<Products>() {
            ...
            public int compare(Products key_1, Products key_2) {
                if(unitPriceSortType.equals("asc")){
                    return key_1.getPricePerUnit() > key_2.getPricePerUnit() ? 1 : -1;
                } else {
    ...
    public String sortProductsByTotalPrice() {
        ...
        Collections.sort(filteredProducts, new Comparator<Products>() {
            ...
            public int compare(Products key_1, Products key_2) {
                if(totalPriceSortType.equals("asc")){
                    return key_1.getTotalPrice() > key_2.getTotalPrice() ? 1 : -1;
                } else {
