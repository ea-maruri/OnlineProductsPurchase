    ...
    public void setAmountStr(String newAmt){
        ...
        if(isInteger(newAmt) && !newAmt.equals("")){
            ...
            if (purchaseNum >= 0) {
                ...
                setErrorStr(String.format("La cantidad de '%s' items no puede ser menor que 0.", getProductName()));
                setPurchaseNum(0);
                amountStr = "0";
            }
        }
        else {
            setErrorStr(String.format("La cantidad de '%s' items debe ser numérica, y mayor a 0.", getProductName()));
            setPurchaseNum(0);
            amountStr = "0";
        }
    }
